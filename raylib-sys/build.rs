...
fn build_with_cmake(src_path: &str) {
    ...
    builder
        ...
        //.define("USE_AUDIO", "OFF") // using soloud audio which has the same backend and not disabling it in raylib will cause compile issues
        // turn off until this is fixed
        .define("SUPPORT_BUSY_WAIT_LOOP", "ON")
        .define("STATIC", "TRUE");
